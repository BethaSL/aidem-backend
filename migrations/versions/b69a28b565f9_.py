...
Revision ID: b69a28b565f9
Revises: 
Create Date: 2022-02-03 11:00:55.426610
...
def upgrade():
    ...
    sa.Column('user_type', sa.Enum('ORGANIZATION', 'PARTICULAR', name='usertype'), nullable=False),
